(function (cjs, an) {
    ...
    console.log('PING!!! MINAJESTY src - 0');
    ...
    (lib.AnMovieClip = function () {
        ...
        console.log('PING!!! MINAJESTY src - 1: lib.AnMovieClip');
    ...
    (lib.mc_tag = function (mode, startPosition, loop, reversed) {
        ...
        console.log('PING!!! MINAJESTY src - 2: lib.mc_tag');
    ...
    (lib.btn_shop = function (mode, startPosition, loop, reversed) {
        ...
        console.log('PING!!! MINAJESTY src - 2: lib.btn_shop');
    ...
    (lib.CR_11155_MINAJESTY_2014_US_DIGITAL_300x600_HTML5 = function (mode, startPosition, loop, reversed) {
        ...
        console.log('PING!!! MINAJESTY src - 4: stage content');
        ...
        console.log('PING!!! MINAJESTY src - 5: timeline functions - MOVED');

        // // this.frame_0 = function () {

        //     console.log('PING!!! MINAJESTY src - 6');

        //     if (this.isSingleFrame) {

        //         console.log('PING!!! MINAJESTY src - 7');

        //         return;
        //     }
        //     if (this.totalFrames == 1) {

        //         console.log('PING!!! MINAJESTY src - 8');
        ...
        // this.frame_0 = function () {
            ...
            console.log('PING!!! MINAJESTY src - 6a: timeline functions - RELOCATED');

            if (this.isSingleFrame) {

                console.log('PING!!! MINAJESTY src - 6b: timeline functions - this.isSingleFrame');

                return;
            }
            if (this.totalFrames == 1) {

                console.log('PING!!! MINAJESTY src - 6c: timeline functions - this.totalFrames == 1');
    ...
    (lib.Stage = function (canvas) {
        ...
        console.log('PING!!! MINAJESTY src - 7: bootstrap callback support');
